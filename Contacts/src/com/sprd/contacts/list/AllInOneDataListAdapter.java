...
public class AllInOneDataListAdapter extends ContactEntryListAdapter {
    ...
    protected static class DataQuery {
		...
		public static final int CONTACT_IMPORT_TYPE = 11;
		public static final int CONTACT_MODE_TYPE = 12;
    ...
    private void configureSelection(
        ...
        Log.d(TAG, "filter.filterType=="+filter.filterType+"getfilter"+getFilter());
...
/*                selection.append(" AND ");
          ...
          //  case ContactListFilter.FILTER_TYPE_ALL_ACCOUNTS:
            	selection.append(" AND " +Contacts.CONTACT_IMPORT_TYPE + " = "+String.valueOf(RawContacts.CONTACTS_BY_LOCAL));
            	break;
            	}
            ...
            case ContactListFilter.FILTER_TYPE_PRIVATECONTACTS:
            	 selection.append(" AND " + Contacts.CONTACAT_MODE_TYPE + " = "+String.valueOf(ContactsApplication.getApplication().mMode));
                break; // private sms  needed.
            default:
    ...
    protected void bindPhoto(final ContactListItemView view, Cursor cursor) {
        ...
        String accountType = cursor.getString(DataQuery.CONTACT_DISPLAY_ACCOUNT_TYPE);
        String accountName = cursor.getString(DataQuery.CONTACT_DISPLAY_ACCOUNT_NAME);
