...
public class GroupBrowseListFragmentSprd extends GroupBrowseListFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (UniverseUtils.UNIVERSEUI_SUPPORT) {
            ...
            setLayout(R.layout.group_browse_list_fragment);
        }
    ...
    public void onStart() {
        ...
        if (UniverseUtils.UNIVERSEUI_SUPPORT) {
            ...
            getLoaderManager().initLoader(LOADER_GROUPS, null, getGroupLoaderListener());
        }
        super.onStart();
    }
	...
	public void onResume() {
		...
		super.onResume();
		getLoaderManager().restartLoader(LOADER_GROUPS, null, getGroupLoaderListener());
	}
        ...
        public Cursor loadInBackground() {
			...
			Cursor groupCursor = getContext().getContentResolver().query(
                    ...
                    Groups.ACCOUNT_TYPE + " NOT NULL AND "
                            ...
                            Groups.FAVORITES + "=0 AND " + Groups.DELETED + "=0"+" AND "+Groups.GROUP_TYPE+" <> 1",
                    null,
