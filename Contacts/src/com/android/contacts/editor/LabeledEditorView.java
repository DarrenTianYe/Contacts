...
public abstract class LabeledEditorView extends LinearLayout implements Editor, DialogShowingView {
    ...
    private void rebuildLabel() {
		...
		if (mState != null && (mSaveImportFlag == RawContacts.CONTACTS_BY_PCTOOLS || mSaveImportFlag ==RawContacts.CONTACTS_BY_EDITE)) {
			rebuildPrivateLabel();
		}
    ...
    /**
     * Build the current label state based on selected {@link EditType} and
     * possible private contacats 
     */
	private void rebuildPrivateLabel() {

		final String[] m_currentMode = { ContactsApplication.getApplication()
				.getString(R.string.private_number) };
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(),
				android.R.layout.simple_spinner_item, m_currentMode);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		mLabel.setAdapter(adapter);
		mLabel.setOnItemSelectedListener(null);
		mLabel.setEnabled(false);
		mLabel.setVisibility(View.VISIBLE);
		mLabel.setSelection(0);
    ...
    private Dialog createCustomDialog() {
        ...
        */
        ...
        /**
        * SPRD:
        *   fix bug130534 when ediingt custom phone type, if copy and paste many times, ANR occurs in contacts
        *
        * Original Android code:
        * 
        * 
    ...
    protected void onTypeSelectionChange(int position) {
        ...
        if (selected.customColumn != null) {
            ...
            */
            if (mListener != null) {
                mListener.onRequest(EditorListener.FIELD_SELECTION_CHANGED);
            }
            /**
            * @}
            */
    ...
    private class EditTypeAdapter extends ArrayAdapter<EditType> {
        private static final String TAG = "EditTypeAdapter";
        ...
        public EditTypeAdapter(Context context) {
          ...
          mSaveImportFlag =mState.getValues().getAsInteger(RawContacts.RAW_CONTACT_IMPORT_TYPE, 0);
            Log.d(TAG, "saveImportFlag="+mSaveImportFlag);
            ...
            if (convertView == null) {
                ...
                */
                ...
                if (UniverseUtils.UNIVERSEUI_SUPPORT){
                    ...
                    textView.setTextColor(0xff1562c0);
    ...
    * @{
    */
    protected Spinner mLabel;
    protected View mDeleteContainer;

    @Override
    public void onTypeListChanged() {
       rebuildLabel();
    }

    protected void setIfTextEmpty(boolean isEmpty) {
        mWasEmpty = isEmpty;
    }
