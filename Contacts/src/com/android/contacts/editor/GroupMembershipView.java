...
public class GroupMembershipView extends LinearLayout
    ...
    public void setGroupMetaData(Cursor groupMetaData) {
        ...
        if (mCreatedNewGroup) {
            ...
            if (mPopup != null) {
                 ...
                 * SPRD:
                 *   Bug 269933
                 *      When to create USIM USIM contacts groups to limit the number
                 *      of groups continue to create new groups, even now a "Sorry,
                 *      contact has stopped running."
                 ...
                 * SPRD:
                 *   Bug 269124
                 *   Edit the contact interface, the information group, enter the name
                 *   of the identified part of the pop group selection box is blocked
                 *
                 * @{
                 */
                 mPopup.dismiss();
            ...
            /**
            * SPRD:
            *   fix bug174067 New Contact, edit group column - Add a new group is determined, the group list option box is displayed directly on the keyboard, and is located at the bottom
            *
            * Original Android code:
            * 
            * 
    ...
    private void updateView() {
        ...
        while (mGroupMetaData.moveToNext()) {
            ...
            * @{
            */
            int deleted = mGroupMetaData.getInt(GroupMetaDataLoader.DELETED);
            if (accountName.equals(mAccountName) && accountType.equals(mAccountType)
                    && Objects.equal(dataSet, mDataSet)
                    && deleted == 0) {
            /**
        ...
        /**
        * SPRD:
        *   Bug 261260 No groups under the premise of the terminal, the
        *   new contacts you can not edit the contact belongs to a group.
         *
        * @orig code
        *         if (!accountHasGroups) {
        *              setVisibility(GONE);
        *              return;
         ...
         */
        if (!accountHasGroups
                && !(PhoneAccountType.ACCOUNT_TYPE.equals(mAccountType) || USimAccountType.ACCOUNT_TYPE
                        .equals(mAccountType))) {
            setVisibility(GONE);
            return;
        }
