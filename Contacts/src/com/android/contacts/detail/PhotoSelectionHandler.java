...
public abstract class PhotoSelectionHandler implements OnClickListener {
    ...
    private int getWritableEntityIndex() {
        ...
        /**
        * SPRD:
        *   fix bug150071 NullPointerException
        *
        ...
        * @{
        */
        if (mIsDirectoryContact || mState == null) return -1;
        /**
        * @}
        */
    ...
    private void startTakePhotoActivity(Uri photoUri) {
        ...
        /**
         * SPRD:
         *   fix bug147592 when no sdcard,set contact photo,take photo,click "finish" no response
         *
         * Original Android code:
         ...
         */
         if (intent == null) {
             Toast.makeText(mContext, R.string.no_sdcard_message, Toast.LENGTH_LONG).show();
         } else {
             startPhotoActivity(intent, REQUEST_CODE_CAMERA_WITH_DATA, photoUri);
         } 
         /**
    ...
    private void startPickFromGalleryActivity(Uri photoUri) {
        ...
        /**
        * SPRD:
        *   fix bug150065 No SD card, contact the pictures to select images from the gallery Settings, tip can't save clip pictures
        *
        * Original Android code:
        * 
        * 
        ...
        */
        if (intent == null) {
            Toast.makeText(mContext, R.string.no_sdcard_message, Toast.LENGTH_SHORT).show();
            return;
        }
        /**
        * @}
    ...
    private int getPhotoPickSize() {
        ...
        // add for bug296739 lowmemory kill the acore, then the Cursor is null.
        int ret = 0;
        try {
            c.moveToFirst();
            ret = c.getInt(0);
        } catch (Exception e) {
            Log.d(TAG, "Cursor encount the Exception", e);
        } finally {
