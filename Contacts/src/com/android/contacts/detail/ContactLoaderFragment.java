...
/**
 * in this screen .this class is not called add by xuhong.tian
 */
/**
...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
	...
	protected static final String TAG = ContactLoaderFragment.class.getSimpleName();
     ...
     * @{
     */
    protected boolean mOptionsMenuOptions;
    protected boolean mOptionsMenuEditable;
    protected boolean mOptionsMenuShareable;
    protected boolean mOptionsMenuCanCreateShortcut;
    protected boolean mSendToVoicemailState;
    protected String mCustomRingtone;
    /**
     * @}
     */
    ...
    protected ContactLoaderFragmentListener mListener;

    protected Contact mContactData;
    /**
     * @}
     */
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (mContactData != null) {
            ...
            isPrivateContacts = mContactData.getDetailUserImportType();
        }

        Log.d(TAG, "isPrivateContacts=="+isPrivateContacts);
        ...
        ShortcutIntentBuilder builder = new ShortcutIntentBuilder(parentActivity,
                new OnShortcutIntentCreatedListener() {
                    ...
                    public void onShortcutIntentCreated(Uri uri, Intent shortcutIntent) {
                        ...
                        /*
                         * SPRD:
                         * bug 263254 remove the createContactShortcutSuccessful prompt.
                         * @{
                         */
