...
public class GroupBrowseListFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /**
        * SPRD:
        *   override in the subclass, so remove it here.
        *
        ...
        */
        if (mLayoutId == 0) {
            ...
            mRootView = inflater.inflate(mLayoutId, null);
        }
        /**
        * @}
        */
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (groupListItem != null) {
                	...
                	Intent intent=privateCallandSmsUtil.getForwardPrivatePhone("", String.valueOf(groupListItem.getNumber()),ContactsApplication.getApplication().mMode);
...
/*        mAddAccountButton.setOnClickListener(new OnClickListener() {
    ...
    private final LoaderManager.LoaderCallbacks<Cursor> mGroupLoaderListener =
		...
		public CursorLoader onCreateLoader(int id, Bundle args) {
			...
			/**
			 * according to the current mode to select the GroupListLoader add by xuhong.tian 2015..3.25
			 */
			if (ContactsApplication.getApplication().mMode == 1) {
				return new GroupListLoader(mContext, 1);
			} else {
    ...
    /**
    * SPRD:
    *   revise the private to protected and can be called in the subclass.
    *
    * Original Android code:
    ...
    */
    ...
    /**
     * SPRD:The following is the code added by sprd, so if you want to add the
     * code by yourself, please add the following which will be easy to maintain.
     *
     * @{
     */
    ...
    public void setGroupListCursor(Cursor data) {
        mGroupListCursor = data;
    }

    public LoaderManager.LoaderCallbacks<Cursor> getGroupLoaderListener() {
        return mGroupLoaderListener;
    }
