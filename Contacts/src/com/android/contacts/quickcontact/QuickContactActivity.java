...
public class QuickContactActivity extends Activity {
    ...
    private static final String TRACE_TAG = "QuickContactActivity";
	...
	/**
	 * add by xuhong.tian on 11.3 that mStarImage is gone. this place do not set starred.
	 */
    ...
    final OnClickListener mAddToContactsClickHandler = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Log.d(TAG, "tian....mContactData.getimport=="+mContactData.getDetailUserImportType()+"");
    ...
    protected void onCreate(Bundle icicle) {
        ...
        */
        if(UniverseUtils.UNIVERSEUI_SUPPORT){
            setContentView(R.layout.quickcontact_activity_new_ui);

            mStopWatch.lap("l"); // layout inflated

            mOpenDetailsOrAddContactImage = (ImageView) findViewById(R.id.open_details_button);
            //mStarImage = (ImageView) findViewById(R.id.open_details_push_layer);
            mListPager = (ViewPager) findViewById(R.id.item_list_pager);
        } else {
            setContentView(R.layout.quickcontact_activity);
            ...
            mTrack = (ViewGroup) findViewById(R.id.track);
            mTrackScroller = (HorizontalScrollView) findViewById(R.id.track_scroller);
            mPhotoView = (ImageView) findViewById(R.id.contact_details_image);
        ...
        if (icicle!=null) {
            int lastTabMargin=icicle.getInt("tab_margin", -1);
            if (lastTabMargin!=-1) {
            final RelativeLayout.LayoutParams layoutParams =
                (RelativeLayout.LayoutParams) mSelectedTabRectangle.getLayoutParams();
            layoutParams.leftMargin = lastTabMargin;
    ...
    private void bindData(Contact data) {
    	...
    	Log.d(TAG, "data=="+data.getDeatailUserMode()+"import"+data.getDetailUserImportType());
        mContactData = data;
        ...
        */
        ...
        if (!mContactData.isUserProfile() && mContactData.getAccount() != null) {
            canStar = SimAccountType.ACCOUNT_TYPE.equals(mContactData
                    .getAccount().type)
                    || USimAccountType.ACCOUNT_TYPE.equals(mContactData
                            .getAccount().type) ? false : true;
        }
        /**
        * @}
        */
       ...
       // mStarImage.setVisibility(View.GONE);
        ...
        if (UriUtils.isEncodedContactUri(lookupUri)) {
           // mStarImage.setVisibility(View.GONE);
			...
			//final String starDescription = mStarImage.getContentDescription().toString();
             /**
             * @}
             */
			
			/**
			 * add by xuhong.tian on 11.3 that mStarImage is gone so .this segment is not be used.
			 */
/*            mStarImage.setOnClickListener(new OnClickListener() { 
                ...
                public void onClick(View view) {
                    ...
                    if (lookupUri != null) {
                        ...
                        *//**
                         * SPRD:
                         *   Bug 259422.
                         *       PB in the phone contacts, add to the home screen, tap a contact
                         *       on the main screen, click starred continuous, even now click invalid
                         *       and can not be canceled or mark Star.
                         * @orig
                         *
                         *  if (isStarred) {
                         *       mStarImage.setImageResource(R.drawable.ic_favorite_off_lt);
                         ...
                         * @{
                         *//*
                        if (!starDescription.equals(mStarImage.getContentDescription().toString())) {
                            return;
                        }
                        if (isStarred) {
                            mStarImage.setImageResource(R.drawable.ic_favorite_off_lt);
        ...
        for (RawContact rawContact : data.getRawContacts()) {
            for (DataItem dataItem : rawContact.getDataItems()) {
                ...
                */
/*                if(UniverseUtils.UNIVERSEUI_SUPPORT &&
                        (Email.CONTENT_ITEM_TYPE.equalsIgnoreCase(mimeType)||
                                Website.CONTENT_ITEM_TYPE.equalsIgnoreCase(mimeType))){
                    continue;
                }*/
                /**
                * @}
                */
                ...
                if (dataKind != null) {
                    ...
                    final Action action = new DataAction(context, dataItem, dataKind,data.getDetailUserImportType(),data.getDeatailUserMode());
                ...
                if (status != null && dataItem instanceof EmailDataItem) {
                    ...
                    if (dataKind != null) {
                        final DataAction action = new DataAction(context, im, dataKind,data.getDetailUserImportType(),data.getDeatailUserMode());
    ...
    private View inflateAction(String mimeType, ResolveCache resolveCache,
        ...
        //typeView.setBackgroundResource(R.drawable.ic_launcher_phone);
    ...
    private LoaderCallbacks<Contact> mLoaderCallbacks =
        ...
        public void onLoadFinished(Loader<Contact> loader, Contact data) {
            ...
            Log.d(TAG, "tian...data.impor="+data.getDetailUserImportType()+"data.number=="+data);
            ...
            */
            if(UniverseUtils.UNIVERSEUI_SUPPORT)
                mListPager.setCurrentItem(0, true);
            /**
            * @}
            */
        }
        ...
        public Loader<Contact> onCreateLoader(int id, Bundle args) {
            ...
            Log.d(TAG, "use this adapter loader................"+mLookupUri);
    ...
    private final QuickContactListFragment.Listener mListFragmentListener =
         ...
         */
        @Override
        public void onItemClicked(final Action action, final int index) {
                ...
                public void run() {
                    try {
                        if (index == 0) {
                            ...
                            if (action.getAlternateIntent() != null) {
                                startActivity(action.getAlternateIntent());
                            }
                        } else if (index == 2) {
                            if (action.getThirdaryIntent() != null) {
                                startActivity(action.getThirdaryIntent());
                            }
                        }
    ...
    */
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(mSelectedTabRectangle != null){
            final RelativeLayout.LayoutParams layoutParams =
                    (RelativeLayout.LayoutParams) mSelectedTabRectangle.getLayoutParams();

            outState.putInt("tab_margin", layoutParams.leftMargin);
        }
    }
    /**
    * @}
