...
public abstract class ContactBrowseListFragment extends
    ...
    private static final String TAG = "ContactBrowseListFragment";
    ...
    public void setFilter(ContactListFilter filter) {	
    	 Log.v(TAG, "New filter_setfilter: " + filter);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
         ...
         */
        if (Log.isIloggable()) {
            Log.stopPerfTracking(Constants.PERFORMANCE_TAG + String.format("Successfully finish loading %s contacts", data.getCount()));
        }
         /**
         * @}
         */
    ...
    private void restoreFilter() {
        mFilter = ContactListFilter.restoreDefaultPreferences(mPrefs,getContext());
    }
