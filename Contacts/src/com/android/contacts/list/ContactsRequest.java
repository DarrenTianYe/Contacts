...
public class ContactsRequest implements Parcelable {
    ...
    /** Show all contacts and activate select the private contacts for fast call */
    public static final int ACTION_VIEW_CONTACT_SELECT_FAST_CALL=141;
    ...
    public void copyFrom(ContactsRequest request) {
        ...
        * @{
        */
        mCascadingData =request.mCascadingData;
        /**
        * @}
        */
    }
    ...
    * @{
    */
    public static final int ACTION_MULTI_PICK_START = 200;
    public static final int ACTION_MULTI_PICK_CONTACT = 201;
    public static final int ACTION_MULTI_PICK_PHONE = 202;
    public static final int ACTION_MULTI_PICK_EMAIL = 203;
    public static final int ACTION_MULTI_PICK_ALL_IN_ONE_DATA = 204;
    public static final int ACTION_MULTI_PICK_ALL_IN_ONE_DATA_NEWUI = 205;
    public static final int ACTION_MULTI_PICK_END = 210;
    
    private List<String> mCascadingData;

	private int mFavrite;
    ...
    public List<String> getCascadingData() {
    return mCascadingData;
    }
	 ...
	 * add by xuhong.tian
	 */
	public void setFavriteFlag(int flag) {
		mFavrite = flag;

		Log.d(">>>>>>>>>>setFavriteFlag", "mFavrite=" + mFavrite);
	}

	public int getFavriteFlag() {
		Log.d(">>>>>>>>>>getFavriteFlag", "mFavrite=" + mFavrite);
		return mFavrite;
	}

	public void setSmsFlag(int flag) {
		Log.d(">>>>>>>>>>setSmsFlag", "mFavrite=" + flag);
		mSmsFlag = flag;
	}

	public int getSmsFlag() {
		Log.d(">>>>>>>>>>getSmsFlag", "mFavrite=" + mSmsFlag);
		return mSmsFlag;
