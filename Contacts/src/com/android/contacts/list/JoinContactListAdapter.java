...
public class JoinContactListAdapter extends ContactListAdapter {
    ...
    public void configureLoader(CursorLoader cursorLoader, long directoryId) {
        ...
        * @{
        */
//        loader.setSelection(Contacts._ID + "!=?" + " AND " + Contacts.DISPLAY_ACCOUNT_TYPE +
//                " not in ( 'sprd.com.android.account.sim', 'sprd.com.android.account.usim')");
//        loader.setSelection(Contacts.CONTACT_IMPORT_TYPE+"=?");
//        loader.setSelectionArgs(new String[]{String.valueOf(RawContacts.CONTACTS_BY_LOCAL)});
        
        loader.setSelection(Contacts._ID + "!=?"+" AND "+Contacts.CONTACT_IMPORT_TYPE+"=?");
        loader.setSelectionArgs(new String[]{String.valueOf(mTargetContactId),String.valueOf(RawContacts.CONTACTS_BY_LOCAL)});
        /**
        * @}
        */
    ...
    protected View newHeaderView(Context context, int partition, Cursor cursor,
        ...
        switch (partition) {
            case PARTITION_SUGGESTIONS: {
                ...
                * @{
                */
                TextView suggestContacts =  (TextView) view.findViewById(R.id.text);
                suggestContacts.setText(R.string.separatorJoinAggregateSuggestions);
                if(UniverseUtils.UNIVERSEUI_SUPPORT){
/*                    suggestContacts
                            .setTextColor(R.color.contact_join_list_aggregate_suggestion_text_color);*/
                }
                /**
                * @}
                */
            ...
            case PARTITION_ALL_CONTACTS: {
                ...
                * @{
                */
                TextView allContacts =  (TextView) view.findViewById(R.id.text);
                allContacts.setText(R.string.separatorJoinAggregateAll);
                if(UniverseUtils.UNIVERSEUI_SUPPORT){
/*                    allContacts.setTextColor(R.color.contact_join_list_aggregate_all_text_color);*/
                }
                /**
                * @}
                */
