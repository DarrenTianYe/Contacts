 ...
 */
public final class GroupMemberCallListLoader extends CursorLoader {
    ...
    public static class GroupEditorQuery {
        ...
        public static final int CONTACT_DATA1           = 6;
        public static final int CONTACT_DATA2           = 7;
        public static final int CONTACT_DATA3           = 8;
        public static final int CONTACT_MIMETYPE           = 9;
	...
	private static final String TAG = "GroupMemberCallListLoader";
    private final long mGroupId;

    /**
     * @return GroupMemberLoader object which can be used in group editor.
     */
    public static GroupMemberCallListLoader constructLoaderForGroupEditorQuery(
            Context context, long groupId) {
        return new GroupMemberCallListLoader(context, groupId, GroupEditorQuery.PROJECTION);
    }

    /**
     * @return GroupMemberLoader object used in group detail page.
     */
    public static GroupMemberCallListLoader constructLoaderForGroupDetailQuery(
            Context context, long groupId) {
        return new GroupMemberCallListLoader(context, groupId, GroupDetailQuery.PROJECTION);
    }

    private GroupMemberCallListLoader(Context context, long groupId, String[] projection) {
        super(context);
