...
public class ImportProcessor extends ProcessorBase implements VCardEntryHandler {
    ...
    public void onEntryCreated(VCardEntry entry) {
        ...
        * @{
        */
        if (mListener != null && (mCurrentCount%20==0 || entry.isIgnorable())) {
        /**
        * @}
        */
            ...
            if (uri != null) {
                ...
                if (Log.isIloggable()) {
                    Log.startPerfTracking(Constants.PERFORMANCE_TAG
                            + ": Start importing one vCard ( Uri: " + uri + ")");
                }
                 /**
                 * @}
                 */
                 ...
                 */
                if (Log.isIloggable()) {
                    Log.startPerfTracking(Constants.PERFORMANCE_TAG + ": Start importing one vCard ( byte[])");
                }
                 /**
                 * @}
                 */
        ...
        */
        ...
        if (successful) {
            ...
            if (isCancelled()) {
                 ...
                 */
                if (Log.isIloggable()) {
                    Log.stopPerfTracking(Constants.PERFORMANCE_TAG+": Successfully finished importing one vCard file: " + uri);
                }
                 /**
                 * @}
                 */
            ...
            */
            if (savedException!=null) {
                mListener.onImportException(mJobId,savedException);     
                } 
            /**
            * @}
            */
