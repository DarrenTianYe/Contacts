...
public class ExportProcessor extends ProcessorBase {
    ...
    private void runInternal() {
         ...
         */
        if (Log.isIloggable()) {
            Log.startPerfTracking(Constants.PERFORMANCE_TAG + String.format(": Start exporting vcard (id: %d)", mJobId));
        }
         /**
         * @}
         */
        ...
        try {
            ...
            */
             ...
             */
            if (Log.isIloggable()) {
                Log.stopPerfTracking(Constants.PERFORMANCE_TAG+": Successfully finished exporting vCard " + request.destUri);
            }
             /**
             * @}
             */
