...
public class ContactLoader extends AsyncTaskLoader<Contact> {
    ...
    private static class ContactQuery {
         ...
         * @{
         */
        public final static int DISPLAY_ACCOUNT_NAME = 65;
        public final static int DISPLAY_ACCOUNT_TYPE = 66;
        /**
         * @}
         */
         ...
         * add by xuhong.tian
         */
        public final static int CONTACT_IMPORT_TYPE = 67;
        public final static int CONTACAT_MODE_TYPE = 68;
        /**
         * add by xuhong.tian
         */
    }
    ...
    private Contact loadContactHeaderData(final Cursor cursor, Uri contactUri) {
         ...
         * @{
         */
        final String displayAccountName=cursor.getString(ContactQuery.DISPLAY_ACCOUNT_NAME);
        final String displayAccountType=cursor.getString(ContactQuery.DISPLAY_ACCOUNT_TYPE);
        
        /**
         * add by xuhong.tian
         */
        final int isUserimport=cursor.getInt(ContactQuery.CONTACT_IMPORT_TYPE);
        final int isUserMode=cursor.getInt(ContactQuery.CONTACAT_MODE_TYPE);


        return new Contact(mRequestedUri, contactUri, lookupUri, directoryId, lookupKey,
                contactId, nameRawContactId, displayNameSource, photoId, photoUri, displayName,
                altDisplayName, phoneticName, starred, presence, sendToVoicemail,
                customRingtone, isUserProfile, displayAccountName, displayAccountType, isUserimport, isUserMode);
        /**
         * @}
         */
    }
    ...
    private ContentValues loadRawContactValues(Cursor cursor) {
         ...
         * add by xuhong.tian
         */
        cursorColumnToContentValues(cursor, cv, ContactQuery.CONTACT_IMPORT_TYPE);
        cursorColumnToContentValues(cursor, cv, ContactQuery.CONTACAT_MODE_TYPE);
    ...
    public void deliverResult(Contact result) {
        ...
        * SPRD:
        *   Bug 272109
        *   Import documents. More VCF file after enter contacts for
        *   imported into the contact, the contact stops running.
        *
        * @orig
        ...
        * @{
        */
        if (isReset() || result == null || result.isError()) {
            return;
        }
        /*
        * @}
