...
public class Contact {
    ...
    */
    ...
    private String mDisplayAccountType;
    /**
    * @}
    */
	...
	private int mUserPrivateContacats=0;
    ...
    private Contact(Uri requestedUri, Contact.Status status, Exception exception) {
         ...
         * @{
         */
        mDisplayAccountName = null;
        mDisplayAccountType = null;
        /**
         * @}
         */
        /**
    ...
    public Contact(Uri requestedUri, Uri uri, Uri lookupUri, long directoryId, String lookupKey,
            ...
            boolean isUserProfile, String displayAccountName, String displayAccountType, int userPctools, int userMode) {
         ...
         * @{
         */
        mDisplayAccountName =  displayAccountName;
        mDisplayAccountType =  displayAccountType;
        /**
         * @}
         */
        /**
         ...
         */
        mUserMode = userMode;
        mUserPrivateContacats= userPctools;
    ...
    public Contact(Uri requestedUri, Contact from) {
         ...
         * @{
         */
        mDisplayAccountName= from.mDisplayAccountName;
        mDisplayAccountType= from.mDisplayAccountType;
        /**
         * @}
         */
        /**
         * add by xuhong.tian
         */
        mUserMode = from.mUserMode;
        mUserPrivateContacats= from.mUserPrivateContacats;
    }
    ...
    public ArrayList<ContentValues> getContentValues() {
        /*SPRD: @{*/
        if(null == mRawContacts){
            Log.i("Contact", "getContentValues: mRawContacts is null");
            return null;
        }
        /*@}*/
    ...
    */
    public AccountWithDataSet getAccount() {
        if (!TextUtils.isEmpty(mDisplayAccountName) && !TextUtils.isEmpty(mDisplayAccountType)) {
            return new AccountWithDataSet(mDisplayAccountName, mDisplayAccountType, null);
        }
        return null;
    }

    public ArrayList<ContentValues> getAllContentValues() {
        ...
        for (RawContact rawContact : mRawContacts) {
            ...
            // If the photo was loaded using the URI, create an entry for the
            // photo
            // binary data.
            if (mPhotoId == 0 && mPhotoBinaryData != null) {
                ContentValues photo = new ContentValues();
    ...
    */
	 ...
	 * @return
	 */
	public int getDeatailUserMode() {
		return mUserMode;
	}

	public int getDetailUserImportType() {
		return mUserPrivateContacats;
	}
}
