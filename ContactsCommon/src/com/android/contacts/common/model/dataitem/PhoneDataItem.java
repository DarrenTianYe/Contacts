...
public class PhoneDataItem extends DataItem {
    ...
    public int getContactsMode() {
       // return getContentValues().getAsInteger(Contacts.CONTACAT_MODE_TYPE);
    	return 0;
    }
    
    public int getContactsIsPublic() {
        //return getContentValues().getAsInteger(Contacts.CONTACT_IMPORT_TYPE);
    	return 0;
    }
}
