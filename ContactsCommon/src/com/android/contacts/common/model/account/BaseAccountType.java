...
public abstract class BaseAccountType extends AccountType {
    ...
    * @{
    */
    public static final String FIELDS_STRUCTUREDNAME = "#displayName";
    public static final String FIELDS_PHONETICNAME = "#phoneticName";
    private static final int MAXLENGTH_TEXTFIELDS_OTHER = 100;
    private static Map<String, Integer> mTextFieldsMaxLength= new HashMap<String,Integer>();
    /**
    * @}
    */
    ...
    */
    ...
    private static void initTextFieldsLength() {
        mTextFieldsMaxLength.put(StructuredName.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Nickname.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Phone.CONTENT_ITEM_TYPE, 40);
        mTextFieldsMaxLength.put(Organization.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(StructuredPostal.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Email.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Im.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Note.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Website.CONTENT_ITEM_TYPE, 200);
        mTextFieldsMaxLength.put(SipAddress.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Photo.CONTENT_ITEM_TYPE, 200);
        mTextFieldsMaxLength.put(Event.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(GroupMembership.CONTENT_ITEM_TYPE, 100);
        mTextFieldsMaxLength.put(Relation.CONTENT_ITEM_TYPE, 100);
    }

    /**
     * @return length of string by chars, for phone/google/exchange/external
     */
    @Override
    public int getAccountTypeFieldsLength(Context context, Account account,
        ...
        Integer maxLen = mTextFieldsMaxLength.get(mimeType);
        if (maxLen != null) {
            return maxLen.intValue();
        } else {
            return MAXLENGTH_TEXTFIELDS_OTHER;
        }
    }
    /**
    * @}
