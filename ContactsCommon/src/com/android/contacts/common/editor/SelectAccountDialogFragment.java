...
public final class SelectAccountDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        /**
        * SPRD:
        *   fix bug131470 copy a single contact, still show the source of the copied items unreasonable
        *
        ...
        * @{
        */
        final Bundle extraArgs = args.getBundle(KEY_EXTRA_ARGS);
        final AccountWithDataSet account = extraArgs.getParcelable("account");
        final AccountsListAdapter accountAdapter = new AccountsListAdapter(builder.getContext(),
                filter, account,0);
        /**
        * @}
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        /**
        * SPRD:
        *   fix bug149916 Landscape, the contact list of id contact number of grey box shows half
        *
        * Original Android code:
        * }
        * 
    ...
    private void onAccountSelected(AccountWithDataSet account) {
         ...
         */
              ...
              ((Listener)getActivity()).onAccountChosen(account, null);
         }
         /**
         * @}
         */
