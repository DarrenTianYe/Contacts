...
public class ContactsUtils {
    ...
    * @{
    */
    public static String pAndwToCommaAndSemicolon(String str) {
        if (null != str) {
            return str.replace('P', ',').replace('W', ';').replace('p', ',')
                    .replace('w', ';');
        } else {
            return null;
        }
    ...
    public static String CommaAndSemicolonTopAndw(String str) {
        if (null != str) {
