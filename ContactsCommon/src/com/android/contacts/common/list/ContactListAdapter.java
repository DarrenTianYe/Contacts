...
public abstract class ContactListAdapter extends ContactEntryListAdapter {
    ...
    protected static class ContactQuery {
        ...
        */
        private static final String[] CONTACT_PROJECTION_PRIMARY = new String[] {
            ...
            Contacts.DISPLAY_ACCOUNT_TYPE,          // 2
            Contacts.DISPLAY_ACCOUNT_NAME,          // 3
            ...
            Contacts.CONTACT_IMPORT_TYPE,            //8
            Contacts.CONTACAT_MODE_TYPE              //9
            /**
            * SPRD:
            * 
            * @{
        ...
        private static final String[] FILTER_PROJECTION_PRIMARY = new String[] {
            ...
            * @}
            */      
            Contacts.CONTACT_IMPORT_TYPE,            //10
            Contacts.CONTACAT_MODE_TYPE              //11
        };
        ...
        * @{
        */
        public static final int CONTACT_DISPLAY_ACCOUNT_TYPE    = 2;
        public static final int CONTACT_DISPLAY_ACCOUNT_NAME    = 3;

        public static final int CONTACT_PRESENCE_STATUS         = 4;
        public static final int CONTACT_CONTACT_STATUS          = 5;
        public static final int CONTACT_PHOTO_ID                = 6;
        public static final int CONTACT_PHOTO_URI               = 7;
        public static final int CONTACT_LOOKUP_KEY              = 8;
        public static final int CONTACT_IS_USER_PROFILE         = 9;
        public static final int CONTACT_SNIPPET                 = 10;
        public static final int CONTACT_SORT_KEY                = 11;
    ...
    */
     ...
     * {@link ListView} position.
     */
    public Cursor getContacCursor(int position) {
    	int partitionIndex = getPartitionForPosition(position);
        Cursor item = (Cursor)getItem(position);
        return item;
    }
