        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    protected void onCreate(Bundle icicle) {
        ...
        */
        if (UniverseUtils.UNIVERSEUI_SUPPORT) {
            setContentView(R.layout.contact_list_filter_custom_overlay);
        } else {
            setContentView(R.layout.contact_list_filter_custom);
        }
        /**
        ...
        if (actionBar != null) {
            ...
            */
            if (UniverseUtils.UNIVERSEUI_SUPPORT) {
                ...
                doneMenuItem.setText(android.R.string.ok);
                ...
                actionBar.setTitle(R.string.custom_list_filter);
            }
            /**
            * @}
            */
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
        ...
        * @{
        */
        private boolean mShowUngrouped = true;

        CustomFilterConfigurationLoader setShowUngrouped(boolean showUngrouped) {
            mShowUngrouped = showUngrouped;
            return this;
        }
        /**
        * @}
        */
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                /**
                * SPRD:
                * fix bug: accountDisplay change with switch language.
                *
                * Original Android code:
                ...
                */
                ...
                if(account.type.equals("sprd.com.android.account.phone")){
                    accountDisplay =new AccountDisplay(resolver, 
                                       context.getString(R.string.label_phone), account.type, account.dataSet);
                } else {
                ...
                */
                ...
                /**
                * SPRD:
                * fix Bug 263275 Custom display contact, the machine will display deleted groups.
                *
                * Original Android code:
                ...
                */
                android.content.EntityIterator iterator =
                        ContactsContract.Groups.newEntityIterator(resolver.query(
                        groupsUri.build(), null, "deleted=0", null, null));
                /**
                * @}
                */
                try {
    ...
    * @{
    */
    private boolean mShowUngrouped;

    protected DisplayAdapter getDisplayAdapter() {
        return mAdapter;
    }

    public CustomContactListFilterActivity() {
        this.mShowUngrouped = true;
    }

    public CustomContactListFilterActivity(boolean showUngrouped) {
        this.mShowUngrouped = false;
    }
